...
setwd("D:/Experiment/nyq/DLPFC/dataset")
# database151507_rctd <- readRDS("D:/Experiment/nyq/DLPFC/dataset/database151507_rctd.rds")

ct_abundance <- read.table('DLPFC151674/rctd_res.txt', sep = '\t', header = TRUE)
...
p <- plot_rctd_spatial_pie(EnDecon = ct_abundance, spot_loc = spot_loc, pie_scale = 0.3)
ggsave(p , file='DLPFC151674/pirchart.pdf',width = 12, height = 5) 
